...
public class KerdoIndexActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kerdo_index);

        setTitle("Вегетативный индекс Кердо");
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (dadText.equals("") || cssText.equals(""))
                    return;
