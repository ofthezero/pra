    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                String mText = ((EditText) originView.findViewById(R.id.editTextM)).getText().toString();

                if (gelText.equals("") || mText.equals(""))
                    return;
                ...
                double m = Integer.parseInt(mText);
