...
public class LevelCardiovascularActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_level_cardiovascular);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (cssText.equals("") || sadText.equals(""))
                    return;
